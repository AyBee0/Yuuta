...
namespace Commands {
    ...
    public class ModeratorCommands : BaseCommandModule {
        ...
        public async Task OTP(CommandContext ctx) {
            ...
            var otherMessage = await ctx.Channel.GetMessageAsync(620260879526789131);
            ...
            otherBuilder.AddField("__LFG Roles__ <:lfgeu:605735395455402004> - <:lfgas:605735840827834393> - <:lfgoce:605735621595758622> - <:lfgna:605735102722342933> - <:lfgconsole:627208072502312990>", "Each region has its own LFG role. For example, if you get the <:lfgeu:605735395455402004> role, and someone does <@&442095956960346113> in <#368503704581701632> (if you have the Overwatch role), you will get pinged.\n*(Note that <:lfgconsole:627208072502312990> is LFG Console)*\n\n**__OTHER__**");
            ...
            #endregion
            await otherMessage.ModifyAsync(embed: otherBuilder.Build());
        }
