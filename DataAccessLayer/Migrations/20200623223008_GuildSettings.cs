        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuildSettingsGuildSettingId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Guilds", x => x.GuildId);
                    table.ForeignKey(
                        name: "FK_Guilds_GuildSettings_GuildSettingsGuildSettingId",
                        column: x => x.GuildSettingsGuildSettingId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Guilds_GuildSettingsGuildSettingId",
                table: "Guilds",
                column: "GuildSettingsGuildSettingId");
